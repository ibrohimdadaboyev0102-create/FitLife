...
const Fitness = () => {
  const images = [
  { src: "https://optim.tildacdn.one/tild3931-3539-4639-b732-373932383262/-/resize/894x/-/format/webp/11.png.webp", width: 450, height: 380, blur: 6, depth: 0.6, top: "5%", left: "5%" },
  { src: "https://optim.tildacdn.one/tild6436-3636-4837-b762-646234316464/-/format/webp/Green-Tennis-Ball-Ba.png.webp", width: 450, height: 380, blur: 5, depth: 0.35, top: "5%", right: "5%" },
  { src: "https://pngfre.com/wp-content/uploads/Kettlebell-8.png", width: 450, height: 380, blur: 4, depth: 0.5, bottom: "0.5%", right: "5%" },
];
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="bg-white/20 backdrop-blur-lg border border-white/20 p-10 rounded-2xl shadow-xl">
          <h1 className="text-3xl font-bold text-green-500 text-center">
            🏋️ Mashg'ulotlar paytini tanlang
          </h1>
