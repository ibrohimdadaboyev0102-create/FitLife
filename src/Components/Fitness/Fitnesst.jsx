...
const Fitnesst = () => {
  ...
  const items2 = [
    "Tushlikda 10 daqiqa badan tarbiya qilish",
    "200-400 m yugurish",
    "1 km yurish",
  ...
  const [checked, setChecked] = useState(Array(items2.length).fill(false));
  ...
  const count2 = checked.filter(Boolean).length;
      ...
      <div className="bg-white/30 backdrop-blur-lg rounded-2xl shadow-xl p-6 w-full max-w-md">
        ...
        {count2 === items2.length && (
          <div className="mt-4 text-center text-green-600 font-bold text-lg">
            🎉 Bugungi tushlikdagi mashqlar bajarildi!
          </div>
        )}
